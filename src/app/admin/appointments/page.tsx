...
import { Search, Filter, Calendar, Phone, ChevronDown } from "lucide-react";
import { mockAppointments, type AppointmentRequest } from "@/data/admin";
                    ...
                    <div className="flex items-center gap-2">
                      {apt.status === "pending" && (
                        <>
                          ...
                          <button className="px-3 py-1 rounded-md text-xs font-medium bg-red-50 text-red-600 hover:bg-red-100 transition-colors">
                            Cancel
                          </button>
                        </>
                      )}
                      {apt.status === "confirmed" && (
                        <button className="px-3 py-1 rounded-md text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 transition-colors">
                          Complete
                        </button>
                      )}
                    </div>
